package com.example.finaltodoapplicaction.Utils;
            ...
            if (cur != null) {
                if (cur.moveToFirst()){
                    do {
                        ...
                        task.setDateTask(cur.getString(cur.getColumnIndex(DATES)));
                        taskList.add(task);
